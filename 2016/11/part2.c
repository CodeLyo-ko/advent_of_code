...
int main() {
    ...
    initial->floors[0][2] = (object_t){elerium, generator};
    initial->floors[0][3] = (object_t){elerium, chip};
    initial->floors[0][4] = (object_t){dilithium, generator};
    initial->floors[0][5] = (object_t){dilithium, chip};
    initial->n_floors[0] = 6;
